  ...
  methods: {
    ...
    getCourseList() {
      this.$axios.get("/course/list/0", {
        ...
        this.compulsoryData = res.data.data.records;
      ...
      this.$refs[studentForm].validate((valid) => {
        if (valid) {
          ...
          if (this.studentForm.startTime instanceof Object) {
            ...
            this.studentForm.endTime = formatDate(this.studentForm.endTime);
          }
          this.$axios.post('/course/' + (this.flag ? 'update' : 'saveCompulsory'), this.studentForm)
              .then(res => {
                this.$message({
                  showClose: true,
